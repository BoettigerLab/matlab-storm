...
% Warning!  Depreciated.  use MatchFiducials from matlab-functions instead
%
% [matched1,matched2,parameters] = MatchFeducials(image1spots,image2spots)
...
if parameters.useCorrAlign && pars.troubleshoot 
    figure(10); clf; 
